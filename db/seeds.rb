...
Resource.create({name: "Life Jacket", cost: 20.00, incrementable: false, unit: "Jacket", item_type: "Protection", value: 3, blurb: "Keeps you afloat in case of tidal wave, bridge collapse or other hazards."})
Resource.create({name: "Rubber Gloves", cost: 2.59, incrementable: true, unit: "Pair", item_type: "Protection", value: 3, blurb: "If disease strikes, these will help you avoid catching it."})
...
Resource.create({name: "10 lb Bag of Rice", cost: 14.99, incrementable: true, unit: "Package", item_type: "Water", value: 120, blurb: "Dry white rice. Cheap, calorically dense."})
...
Resource.create({name: "Gas Mask", cost: 148.99, incrementable: true, unit: "Can", item_type: "Special", value: 2, blurb: "Tactical gas mask. Protects you from inhaling toxic materials."})
Resource.create({name: "Hazmat Suit", cost: 178.99, incrementable: true, unit: "Can", item_type: "Special", value: 2, blurb: "Full body cover to protect from biohazard and disease."})
Resource.create({name: "Cat Food", cost: 0.59, incrementable: true, unit: "Can", item_type: "Special", value: 1, blurb: "Meow meow meow meow meow meow meow meow."})
